...
public class PublishToSliderGrip extends AsyncTask<String, Void, String> {

    private static final String TAG = "PublishToTopicGrip";
    private KontrolActivity kontrolActivity;

    public PublishToSliderGrip(KontrolActivity kontrolActivity) {this.kontrolActivity = kontrolActivity;
    }
