...
public class PublishToSliderElbowKombinasi extends AsyncTask<String, Void, String> {

    private static final String TAG = "PublishToTopicElbow";
    private KombinasiActivity kombinasiActivity;

    public PublishToSliderElbowKombinasi(KombinasiActivity kombinasiActivity) {this.kombinasiActivity = kombinasiActivity;
    }
