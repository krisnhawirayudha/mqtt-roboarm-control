...
public class PublishToSliderShoulder extends AsyncTask<String, Void, String> {

    private static final String TAG = "PublishToTopicShoulder";
    private KontrolActivity kontrolActivity;

    public PublishToSliderShoulder(KontrolActivity kontrolActivity) {this.kontrolActivity = kontrolActivity;
    }
