...
//
//public class PublishToTopicElbow extends AsyncTask<String, Void, String> {
//
//    private static final String TAG = "PublishToTopicTask";
//    private MainActivity mainActivity;
//
//    public PublishToTopicElbow(MainActivity mainActivity) {
...
//                    .topicFilter("elbow")
//                    .callback(publish -> {
//                        String elbow = new String(publish.getPayloadAsBytes());
//                        Log.i(TAG, "Menerima sudut Elbow: " + elbow);
//
//                        // Update UI dengan umur
//                        mainActivity.updateElbowOnUI(elbow);
//
//                        // Tampilkan pesan Toast saat menerima pesan
//                        mainActivity.showToast("Menerima pesan dari topik 'Elbow': " + elbow);
//                    })
//                    .send();
//
