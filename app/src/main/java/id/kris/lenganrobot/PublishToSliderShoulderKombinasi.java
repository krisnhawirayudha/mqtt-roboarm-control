...
public class PublishToSliderShoulderKombinasi extends AsyncTask<String, Void, String> {

    private static final String TAG = "PublishToTopicShoulder";
    private KombinasiActivity kombinasiActivity;

    public PublishToSliderShoulderKombinasi(KombinasiActivity kombinasiActivity) {this.kombinasiActivity = kombinasiActivity;
    }
