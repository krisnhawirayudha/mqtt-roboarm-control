...
public class PublishToSliderBaseKombinasi extends AsyncTask<String, Void, String> {

    private static final String TAG = "PublishToTopicTask";
    private KombinasiActivity kombinasiActivity;

    public PublishToSliderBaseKombinasi(KombinasiActivity kombinasiActivity) {this.kombinasiActivity = kombinasiActivity;
    }
